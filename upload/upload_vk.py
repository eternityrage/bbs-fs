...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 BabySteps FishSpa Daily!\n\n#fitness #strengthtraining #gym"
        ...
        video = upload.video(
            ...
            name=title or 'BabySteps FishSpa Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "BabySteps FishSpa"
